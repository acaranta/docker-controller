...
def container_stop(imgdata):
    ...
    if container in pslist['names']:
      ...
      print("##################################################")
      print("Container stop : container not found on this host")
      print("##################################################")

def image_update(imgdata):
